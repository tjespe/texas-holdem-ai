...
from tensorflow.keras.optimizers.legacy import (
    Adam,
)  # Using legacy because it runs faster on M1 Macs
import json
import re
import gc
...
plt.legend()
plt.savefig("validation_loss_per_fold.png")
...
plt.legend()
plt.savefig("means_of_predictions_vs_actuals.png")
...
plt.legend()
plt.savefig("stds_of_predictions_vs_actuals.png")
